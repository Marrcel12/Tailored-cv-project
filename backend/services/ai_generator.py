...
def generate_tailored_cv(cv_text, job_description, system_instruction=None, temperature=0.7):
    ...
    try:
        response = client.chat.completions.create(
            ...
            messages=[
                {
                    "role": "system",
                    "content": "You are a helpful assistant that writes professional CVs. You always return valid JSON.",
                },
