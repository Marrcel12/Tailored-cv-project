def render_template(data, template_id, profile_pic_base64):
    ...
    profile_img_tag = f'<img src="data:image/jpeg;base64,{profile_pic_base64}" class="profile-pic">' if profile_pic_base64 else ''
    linkedin_div = f'<div><strong>LinkedIn:</strong><br>{personal_info.get("linkedin", "")}</div>' if personal_info.get('linkedin') else ''
